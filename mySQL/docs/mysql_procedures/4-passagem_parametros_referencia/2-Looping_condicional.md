...
Nesse curso, tentamos sempre criar situações para aplicarmos as Procedures.
...
No looping, primeiro testaremos o dia da semana. Então, abaixo de DO, passamos SET vDiaSemana = (SELECT DAYOFWEEK(SRT_TO_DATE(vDataFinal, ''%Y-%m-%d))).
...
Antes de rodar, na linha 5 e 8, mudamos a rotina para novoAluguel_42. Feito isso, selecionamos todo o código e executamos. Se nos Schemas, clicarmos com o botão direito em "Stored Procedures" e depois em "Refresh All", visualizamos a procedure 42.

Agora, faremos um teste. Passamos a chamada CALL novoAluguel_42('10010','Gabriela Pires', '8635', '2023-04-12',5,40);.
