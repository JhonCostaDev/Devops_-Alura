...
Próximos passos
No vídeo anterior, criamos a tabela temp_nomes, que possui a lista de nomes que vamos incluir como múltiplos aluguéis.

No próximo vídeo, vamos montar um CURSOR percorrendo toda a tabela temp_nomes para entender o funcionamento do CURSOR na prática no MySQL.
...
O CURSOR é aberto, percorre linha a linha os registros selecionados e é fechado ao final, liberando recursos.
