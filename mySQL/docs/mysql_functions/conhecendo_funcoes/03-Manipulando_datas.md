...
DATAATUAL
2024-03-01 08:37:05
Ao executar, é retornada a data atual do momento de gravação do vídeo. Quando você for executar essa consulta, vai aparecer para você a data e hora do momento em que você está executando essa consulta.
